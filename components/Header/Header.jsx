...
const Header = () => {
  ...
  return (
    <div className='border fixed w-72  h-[100vh] flex flex-col items-center gap-8'>
       <div className=' border w-40 cursor-pointer h-40 hover:animate-pulse  mt-5 flex justify-center items-center' style={{borderRadius:"50%"}}>
       <Image 
        src={'/img.jpg'}
        width={1000}
        alt='assa'
