  ...
  return (
   ...
   <div className='flex justify-end fixed  z-30 '>
    ...
    <div className={`' fixed  flex flex-col items-center gap-7 z-30   navbar overlay  ${isMenuOpen ? 'open' : ''} '`}  >
                ...
                <a href=''  className=' bg-slate-700 w-10 h-10 transition-transform duration-100 transform hover:scale-150 hover:bg-blue-600 hover:w-11 hover:h-11 flex justify-center items-center ' style={{borderRadius:"50%"}}>
              ...
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 320 512" height="18" width="18" xmlns="http://www.w3.org/2000/svg"><path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path></svg>
                ...
                <div className='flex  flex-col  ml-12 gap-5 mt-4 mb-10'>
                    <a href="#" onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3 Animatsiya ' style={{fontWeight:"600"}}>
                      <div>
                    ...
                    <a href="#About" onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3 Animatsiya ' style={{fontWeight:"600"}}>
                    <div>
                    ...
                    <a href="#Resume" onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3 Animatsiya ' style={{fontWeight:"600"}}>
                    ...
                    <a href="#Skills" onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3 Animatsiya ' style={{fontWeight:"600"}}>
                    ...
                    <a href="#Portfolio" onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3 Animatsiya' style={{fontWeight:"600"}}>
                      <div>
                      ...
                      <a href="#Contact" onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3 Animatsiya  ' style={{fontWeight:"600"}}>
                      <div>
