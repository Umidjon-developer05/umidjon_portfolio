  ...
  return (
    <div className={`' fixed  h-[100vh] flex flex-col items-center gap-8 z-30   ${resolvedTheme ==='dark' && 'bg-slate-950'}'`} >
        ...
        <div className='w-10 h-10 cursor-pointer border flex justify-center items-center  mt-3 ml-3' style={{ borderRadius: '50%' ,display:`${isMenuOpen ? 'none':'block'}`}} onClick={toggleMenu}>
          ...
          <div style={{display:`${isMenuOpen ? 'block ':'none'}`,marginTop:'-35px'}} className='bg-slate-950   border  w-60  h-[100vh] flex flex-col items-center gap-8'>
        <div >
  ...
  <path d="M16 .5C7.437.5.5 7.438.5 16S7.438 31.5 16 31.5c8.563 0 15.5-6.938 15.5-15.5S24.562.5 16 .5zm7.613 10.619l-2.544 11.988c-.188.85-.694 1.056-1.4.656l-3.875-2.856-1.869 1.8c-.206.206-.381.381-.781.381l.275-3.944 7.181-6.488c.313-.275-.069-.431-.482-.156l-8.875 5.587-3.825-1.194c-.831-.262-.85-.831.175-1.231l14.944-5.763c.694-.25 1.3.169 1.075 1.219z"/>
         ...
         <div className='flex  flex-col  ml-12 gap-8 mt-6'>
            <Link href={'/'} onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3' style={{fontWeight:"600"}}>
              <div>
              <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="Sidebar_icon__czDJe" height="22" width="22" xmlns="http://www.w3.org/2000/svg"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>  
              </div>  
              <div>
              Home
              </div>
            ...
            <Link href={'/About'} onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3' style={{fontWeight:"600"}}>
              <div>
              <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="Sidebar_icon__czDJe" height="22" width="22" xmlns="http://www.w3.org/2000/svg"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
              </div>
              <div>
              About
              </div>
            ...
            <Link href={'/'} onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3' style={{fontWeight:"600"}}>
              ...
              <div>
              <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="Sidebar_icon__czDJe" height="22" width="22" xmlns="http://www.w3.org/2000/svg"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M3 21h4l13 -13a1.5 1.5 0 0 0 -4 -4l-13 13v4"></path><path d="M14.5 5.5l4 4"></path><path d="M12 8l-5 -5l-4 4l5 5"></path><path d="M7 8l-1.5 1.5"></path><path d="M16 12l5 5l-4 4l-5 -5"></path><path d="M16 17l-1.5 1.5"></path></svg>
              </div>
              <div>
              Skills
              </div>
            ...
            <Link href={'/Portfolio'} onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3' style={{fontWeight:"600"}}>
              <div>
              <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" class="Sidebar_icon__czDJe" height="22" width="22" xmlns="http://www.w3.org/2000/svg"><path d="M14 11H10V13H14V11Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M7 5V4C7 2.89545 7.89539 2 9 2H15C16.1046 2 17 2.89545 17 4V5H20C21.6569 5 23 6.34314 23 8V18C23 19.6569 21.6569 21 20 21H4C2.34314 21 1 19.6569 1 18V8C1 6.34314 2.34314 5 4 5H7ZM9 4H15V5H9V4ZM4 7C3.44775 7 3 7.44769 3 8V14H21V8C21 7.44769 20.5522 7 20 7H4ZM3 18V16H21V18C21 18.5523 20.5522 19 20 19H4C3.44775 19 3 18.5523 3 18Z" fill="currentColor"></path></svg>
              </div>
              <div>
                Portfolio
              </div>
            ...
            <Link href={'/'} onClick={closeMenu} className='text-[20px] text-left flex items-center gap-3' style={{fontWeight:"600"}}>
              <div>
              <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="Sidebar_icon__czDJe" height="22" width="22" xmlns="http://www.w3.org/2000/svg"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
              </div>
              <div>
                Contact
              </div>
