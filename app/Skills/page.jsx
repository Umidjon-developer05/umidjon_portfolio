...
const Skills = () => {
  ...
  return (
    <div className='container sm:h-[600px] ' style={{ backgroundImage: 'url(/bg2.svg)', width: "100%" ,backgroundSize:"contain",backgroundRepeat:"no-repeat"}}>
    ...
    <div className='bg-blue-700 w-full h-1 rounded-2xl' data-aos="zoom-in">
      ...
      <div className='flex flex-col flex-wrap items-center'  data-aos="fade-up">
          <div className='flex justify-between w-full'>
                <button className='border w-[50%] h-16' onClick={()=>Technologies('Frontend')}>Frontend</button>
                <button className='border w-[50%] h-16' onClick={()=>Technologies('Backend')}>Backend</button>
          </div>
          <div>
            {
                Lang ? 
