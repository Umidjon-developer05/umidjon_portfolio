...
const Resume = () => {
  return (
    <div id='Resume' className='container sm:h-[500px] flex justify-center  mx-5   flex-col ' style={{ backgroundImage: 'url(/bg2.svg)', width: "100%" ,backgroundSize:"contain",backgroundRepeat:"no-repeat"}}>
