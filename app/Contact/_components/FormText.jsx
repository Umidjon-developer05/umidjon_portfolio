...
const FormText = () => {
  return (
    <div>
        ...
        <h1 className='font-serif sm:text-[20px]'> Reach out and let's bring your ideas to life! </h1>
        <h2 className='font-serif sm:text-[20px]'> I am available for freelance work.</h2>
        <h2 className='font-serif sm:text-[20px]'>+998 93 655 89 59</h2>
